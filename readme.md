...
|     名称     | <a id="admin_ownerInit">管理员初始化</a> |
| :----------: | ---------------------------------------- |
...
|     名称     | <a id="admin_integralInit">积分系统初始化</a> |
| :----------: | :-------------------------------------------- |
